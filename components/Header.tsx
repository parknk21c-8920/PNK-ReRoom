      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 py-3.5 sm:flex-row sm:px-6">
        ...
        <div className="flex w-full items-center justify-between sm:w-auto">
          <a href="#top" className="group flex items-center justify-start gap-3">
            <img src="/logo.jpg" alt="Logo" className="h-8 w-auto object-contain rounded-full shadow-sm sm:h-14" />
            ...
            <span className="hidden rounded-full border border-line-strong px-2 py-0.5 text-[9px] font-bold uppercase tracking-[0.22em] text-ink-soft sm:inline-block">
              AI Beta
            </span>
          </a>
        ...
        {/* 내비게이션 & PC 우측 영역 */}
        <div className="flex w-full items-center sm:w-auto sm:gap-4">
          ...
          <button
            onClick={() => setLang(lang === 'ko' ? 'en' : 'ko')}
            className="hidden items-center rounded-full border border-line-strong bg-white p-0.5 shadow-sm transition-colors sm:flex hover:border-ink"
          >
